...
# /start sarhni_<token>
# group=-1 لضمان تنفيذه قبل /start العادي في private_sudos (group=0)
# والفلتر يتحقق مباشرة من وجود sarhni_ في الرابط
@Client.on_message(filters.private & filters.command("start") & filters.regex(r"^/start sarhni_"), group=-1)
