...
# ============================================================
# 4) مسح <فئة>
# group=5 لضمان تنفيذه بعد handlers الأوامر الأخرى (مسح رد، مسح الردود...)
# إذا لم تطابق الكلمة فئة معروفة يتجاهل البوت الرسالة بهدوء
@Client.on_message(filters.group & filters.regex(r"^مسح\s+(.+)$"), group=5)
